		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#incturecomproject4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"incturecomproject4-display": {
								"semanticObject": "incturecomproject4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=incture.com.project4",
									"url": sap.ui.require.toUrl("incture/com/project4")
								}
							}
						}
					}
