		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData App",
									"targetURL": "#cominctureodataapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominctureodataapp-display": {
								"semanticObject": "cominctureodataapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.incture.odataapp",
									"url": sap.ui.require.toUrl("com/incture/odataapp")
								}
							}
						}
					}
